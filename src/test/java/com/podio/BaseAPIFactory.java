...
public class BaseAPIFactory {
	...
	private static final BaseAPI BASE_API = new BaseAPI("localhost",
			"localhost", 9090, false, true, new OAuthClientCredentials(
					"dev@hoisthq.com", "CmACRWF1WBOTDfOa20A"),
			new OAuthUsernameCredentials("dev@hoisthq.com", "AARehARgE1NFPQUv"));
